...
<?php 
echo "<center><p>Showing results for 'cattle'</p><center>";
?>
	<br>
	<br>
	<center><a style="margin-left: -78px; font-size: 25px; color: blue;" href="/cattle.php">Bauman Red Angus - Cattle</a></center>
	<br>
