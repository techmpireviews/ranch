	...
	<div class="search">
		<span class="searchformspan">
			<form autocomplete="off" id="searchform" action="search.php" method="post">
				...
				<input style="margin-left: 5px;" value="horses" autocomplete="off" id="searchid" type="text" name="search">
			</form>
		</span>
	</div>
...
?>
	<br>
	<br>
	<center><a style="margin-left: -46px; font-size: 25px; color: blue;" href="/about.php">Bauman Red Angus - Horses</a></center>
	<br>
	<center><a style="font-size: 20px; color: green;" href="/horses.php">https://www.baumanredangus.com/horses.php</a></center>
