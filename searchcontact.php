	...
	<div class="search">
		<span class="searchformspan">
			<form autocomplete="off" id="searchform" action="search.php" method="post">
				...
				<input style="margin-left: 5px;" value="contact us" autocomplete="off" id="searchid" type="text" name="search">
			</form>
		</span>
	</div>
...
<?php 
echo "<center><p>Showing results for 'contact us'</p><center>";
?>
	<br>
	<br>
	<center><a style="margin-left: -46px; font-size: 25px; color: blue;" href="/about.php">Bauman Red Angus - Contact Us</a></center>
	<br>
